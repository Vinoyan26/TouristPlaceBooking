...
<div class="container">
    <form action="{{ route('place.store') }}" method="post" enctype="multipart/form-data" onsubmit="return(validate());" name="createform">
    @csrf
        ...
        <div class="form-row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="guider" id="guider" required class="form-control" placeholder='Name'>
            </div>            
        </div>
        ...
        <div class="form-row">
            <div class="col-md-12 mb-3">
                ...
                <textarea name="description" id="description" cols="description" rows="2" cols="4" class="form-control"  required></textarea>
            </div>
        </div>
